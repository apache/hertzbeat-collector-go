...
type MetricsData struct {
	...
	Code     int               `json:"code"`
	Msg      string            `json:"msg"`
	Fields   []jobtypes.Field  `json:"fields"`
...
type CollectDataDispatcher interface {
	DispatchCollectData(timeout *jobtypes.Timeout, metrics *jobtypes.Metrics, data []*MetricsData) error
}
...
func (b *MetricsDataBuilder) SetFields(fields []jobtypes.Field) *MetricsDataBuilder {
...
func (mc *MetricsCollect) convertToMetricsData(collectedData *jobtypes.CollectRepMetricsData, builder *MetricsDataBuilder) *MetricsData {
