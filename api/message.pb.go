...
type Message struct {
	...
	// message direction
	Direction Direction `protobuf:"varint,2,opt,name=direction,proto3,enum=hertzbeat.apache.org.api.message.Direction" json:"direction,omitempty"`
	// message type
	Type MessageType `protobuf:"varint,3,opt,name=type,proto3,enum=hertzbeat.apache.org.api.message.MessageType" json:"type,omitempty"`
	// message content
...
const file_message_proto_rawDesc = "" +
	...
	"\bRESPONSE\x10\x01BL\n" +
	" org.apache.hertzbeat.api.messageZ(hertzbeat.apache.org/api/message;messageb\x06proto3"
...
var file_message_proto_goTypes = []any{
	(MessageType)(0), // 0: hertzbeat.apache.org.api.message.MessageType
	(Direction)(0),   // 1: hertzbeat.apache.org.api.message.Direction
	(*Message)(nil),  // 2: hertzbeat.apache.org.api.message.Message
}
var file_message_proto_depIdxs = []int32{
	1, // 0: hertzbeat.apache.org.api.message.Message.direction:type_name -> hertzbeat.apache.org.api.message.Direction
	0, // 1: hertzbeat.apache.org.api.message.Message.type:type_name -> hertzbeat.apache.org.api.message.MessageType
